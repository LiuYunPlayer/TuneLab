...
public interface IReadOnlyDataObjectList<out T> : IReadOnlyDataList<T> where T : IDataObject
{
    ...
    // 用 new 强化继承自 IReadOnlyNotifiableEnumerable 的 IActionEvent MembershipModified，给宿主消费者拿带 canIgnore 的富版。
    new IModifiedEvent MembershipModified { get; }
    ...
    IActionEvent IReadOnlyNotifiableEnumerable<T>.MembershipModified => MembershipModified;
}
