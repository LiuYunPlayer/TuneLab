...
internal static class SynthesisSnapshotFactory
{
    ...
    public static SynthesisSnapshot Capture(MidiPart part, IReadOnlyList<ISynthesisNote> sourceNotes, double startTime, double endTime)
    {
        ...
        var pitch = new SynthesisAutomationSnapshot(new FrozenFinalEvaluator(
        ...
        var pitchDeviation = new SynthesisAutomationSnapshot(new FrozenFinalEvaluator(
        ...
        foreach (var kvp in part.Voice.AutomationConfigs)
        {
            ...
            automations.Add(key, new SynthesisAutomationSnapshot(new FrozenFinalEvaluator(
                baseEvaluator,
