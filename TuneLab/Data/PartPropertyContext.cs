...
internal sealed class PartPropertyContext(string voiceId, PropertyObject partProperties) : IPartPropertyContext
{
    public static readonly PartPropertyContext Empty = new(string.Empty, PropertyObject.Empty);
