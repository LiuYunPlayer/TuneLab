...
public static class IValueControllerExtension
{
    ...
    public static IDisposable BindProperty<T>(this IValueController<T> controller, INotifiableProperty<T> property, bool syncWhileModifying = false)
    {
        return new NotifiablePropertyBinding<T>(controller, property, syncWhileModifying);
    }
