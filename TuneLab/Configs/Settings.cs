...
internal static class Settings
{
    ...
    public static NotifiableProperty<bool> IsAutoDownloadUpdate { get; } = DefaultSettings.IsAutoDownloadUpdate;
    ...
    public static void Init(string path)
    {
        ...
        IsAutoDownloadUpdate.Value = settingsFile.IsAutoDownloadUpdate;
    }
    ...
    public static void Save(string path)
    {
        try
        {
            var content = JsonSerializer.Serialize(new SettingsFile()
            {
                ...
                IsAutoDownloadUpdate = IsAutoDownloadUpdate,
