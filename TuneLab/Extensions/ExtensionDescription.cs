...
//
// 继承 ExtensionInfo：单插件可省略 extensions[]，直接把 type/engine/class/assembly 等写在顶层，
...
internal class ExtensionDescription : ExtensionInfo
{
    ...
    // 归一化：有 extensions[] 以它为准（顶层 type/engine/class 忽略）；否则顶层字段定义那唯一的单插件。
    [JsonIgnore]
