...
//
// 坐标系约定：自动化查询轴 = 全局秒，与音频产物、状态段同一时间系（与 IVoiceContext 一致）。
public interface IEffectContext
{
    ...
    // 处理器订阅 ISynthesisAutomation.RangeModified、按本段时间界自筛标脏。
    ...
    // 逻辑编辑收口（同 IVoiceContext.Committed）：颗粒事件（Input.Committed/Properties.Modified/
