...
public interface IEffectEngine
{
    ...
    IReadOnlyOrderedMap<PropertyKey, AutomationConfig> GetAutomationConfigs(IEffectPropertyContext context);
    ...
    IReadOnlyOrderedMap<PropertyKey, AutomationConfig> GetSynthesizedParameterConfigs(IEffectPropertyContext context);
